...
class HowTosControllerTest < ActionController::TestCase
  ...
  test "should create how_to" do
    assert_difference('HowTo.count') do
      post :create, how_to: { how_to_id: @how_to.how_to_id, how_to_title: @how_to.how_to_title, how_to_url: @how_to.how_to_url }
    end
  ...
  test "should update how_to" do
    patch :update, id: @how_to, how_to: { how_to_id: @how_to.how_to_id, how_to_title: @how_to.how_to_title, how_to_url: @how_to.how_to_url }
    assert_redirected_to how_to_path(assigns(:how_to))
  end
